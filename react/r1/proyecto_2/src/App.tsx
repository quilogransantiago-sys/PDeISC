// Componente raíz: muestra una tarjeta de presentación y el botón de tema.
// Dependencias: ./components/TarjetaPresentacion, ./scripts/useTema,
//               ./App.css, ./assets/avatar.svg
